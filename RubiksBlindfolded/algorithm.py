...
print("✅ algorithm.py import됨", flush=True)
...
def setCube(sides):
    global cube
    cube = sides
    print("📦 setCube 적용된 상태 =", cube, flush=True)
...
def solveCorners():
    ...
    print("📌 현재 cornerPriority =", cornerPriority, flush=True)
    print("✅ solveCorners 시작됨", flush=True)
    cube = cubeCorners.solveCorner(cube,cornerPriority)
    cornerSequence = cubeCorners.getCornerSequence()
    print("🧩 [디버그] solveCorners 결과 =", cornerSequence, flush=True)
...
def solveEdges():
    global cube
    global edgeSequence
    print("📌 현재 edgePriority =", edgePriority, flush=True)  
    print("✅ solveEdges 시작됨", flush=True)
    corners = solveCorners()
    cube = cubeEdges.solveEdge(cube,edgePriority, corners)
    edgeSequence = cubeEdges.getEdgeSequence()
    print("🧩 [디버그] solveEdges 결과 =", edgeSequence, flush=True)
